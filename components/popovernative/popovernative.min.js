(function () {
  ...
  function getRoots() {
    return Array.from(document.querySelectorAll("[data-tui-popovernative-root]"));
  }
  ...
  function isHoverRoot(root) {
    return getTriggers(root).some(
      (trigger) => trigger.getAttribute("data-tui-popovernative-type") === "hover",
    );
  }
    ...
    computePosition(reference, content, { placement, middleware }).then(
      ({ x, y, placement: finalPlacement, middlewareData }) => {
        ...
        if (arrowEl && middlewareData.arrow) {
          ...
          arrowEl.setAttribute("data-tui-popovernative-placement", finalPlacement);
  ...
  document.addEventListener("click", (event) => {
    ...
    if (trigger && root && triggerType !== "hover" && triggerType !== "manual") {
