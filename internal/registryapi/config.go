...
//   - BASES is ["base"]: shadcn-templ has exactly one Go implementation of every
...
//     shadcn-templ pendant (a consumer project is any Go module).
...
// Bases: shadcn-templ ships one implementation, so only "base" exists (shadcn:
// base | aria | radix).
...
// IconLibraryNames in shadcn/icons iconLibraries key order. shadcn-templ compiles
